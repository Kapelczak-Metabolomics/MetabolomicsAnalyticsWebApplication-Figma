...
export function Sidebar() {
  ...
  return (
    <div className="flex h-full w-56 flex-col border-r border-border bg-gradient-to-b from-sidebar via-sidebar to-sidebar/95">
      ...
      <nav className="flex-1 space-y-0.5 overflow-auto p-2">
        ...
        {adminOpen && (
          <div className="ml-3 space-y-0.5 border-l border-sidebar-border pl-3 mt-0.5">
